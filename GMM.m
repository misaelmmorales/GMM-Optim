...
maxiter = 10;          % Stopping criteria 2: maximum number of iterations
%
...
title('Original Data + NMS Contours');
...
title('Original Data + QN Contours');
